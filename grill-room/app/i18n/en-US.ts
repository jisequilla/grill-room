const messages = {
  ...
  workspace: {
    ...
    deferralHint: "This reads like a deferral.",
    saveAsDefer: "Save as Defer",
    saveAsAnswer: "Save as my answer",
  ...
  output: {
    ...
    visibilityUnchecked: "Could not check",
    ...
    visibilityUncheckedHeading: "Could not check whether these files are ignored",
