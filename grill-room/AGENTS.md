...
| `submit-round` | Settle an open round's decisions and ask for the next round. A steering move does not settle its decision. Refuses a round with unanswered cards. |
